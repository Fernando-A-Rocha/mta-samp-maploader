...
function (startedResource)
	...
	for k, id in pairs(ids) do
		...
		local worked, reason = exports.newmodels:addExternalMod_CustomFilenames("object", id, 1337, name, dff, txd, col)
		if not worked then
			outputDebugString(id.." failed to add, aborting", 1)
			break
		end
	end
end)

-- Fernando: ID => {dff,txd file names}
SAMP_FILES = { 
